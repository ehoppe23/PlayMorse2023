/* 
Simon Says
A game of replicating patterns of dots/dashes and their paired sound. 
Dots/dashes for a letter or word appear while the corresponding sounds play, 
then the user can replicate the sounds for the letter/word to appear.
...
const SimonSays = forwardRef((props, ref) => {
...
const RadioContent = () => {
    return (
        <div className="radiocontent" >
            ...
            <p id="tutorialText" value="Change Text">Welcome to the Simon Says game! </p>
