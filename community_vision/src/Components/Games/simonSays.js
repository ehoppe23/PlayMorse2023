...
//lists to use -- start with easy list, then switch to hard upon completion
var easyList = "AEIMNT";
var hardList = "BCDFGHJKLOPQRSUVWXYZ";
list = easyList;
...
function spawnMonster(){
    ...
    if(currentImage == 0){
        document.getElementById('monsterImage').src = monster1;
    }
    else if(currentImage == 1){
        document.getElementById('monsterImage').src = monster2;
    }
    else if(currentImage == 2){
        document.getElementById('monsterImage').src = monster3;
    }
    else if(currentImage == 3){
        document.getElementById('monsterImage').src = monster4;
    }
}
...
function updateTutorial() {
    ...
    if (textIndex == 0) {
        ...
        textIndex++;
        var str = document.getElementById('sampleMorseCode');
        var elem = document.getElementsByTagName('animated.p')[0];
        var timeBetween = 42;
...
const simonSays = forwardRef((props, ref) => { //CHANGE ME
    ...
    //sounds
    const [playDash] = useSound(  dashSound, { volume: volume / 100 }, { playbackRate: 4 } );
    ...
    //check if input is correct and react accordingly
    React.useEffect(() => {
        if (input === currentMorse) {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    if (index != list.length - 1) {
                        ...
                        score++;
                        lettersMastered = lettersMastered + currentLetter;
                        if(score >= 5 && scrambled == false){
                            list = hardList;
                        }
                    } else {
                        setIndex(0);
            ...
            setTimeout(() => {
                for(var i = 0; i < currentMorse.length; i++){
                    if(currentMorse.charAt(i) == '•'){
                        setTimeout(() => {
                            playDot();
                        }, i * 750);
                    } else if(currentMorse.charAt(i) == '-'){
                        setTimeout(() => {
                            playDash();
                        }, i * 750);
                    }
    ...
    //plays morse code for current letter
    React.useEffect(() => {
        if (input === "" && !startScreen && !endScreen) {
            setTimeout(() => {
                for(var i = 0; i < currentMorse.length; i++){
                    if(currentMorse.charAt(i) == '•'){
                        setTimeout(() => {
        ...
        <div style={{
                                ...
                                <Grid item style={{ userSelect: 'none', cursor: 'default' }}>
                                    <Card>
                                        ...
                                        <p id= "instructions" style={{
                                            ...
                                            fontSize: '4vh',
                                            display: 'none'
                                        }}>These monsters are in your way! Copy the Morse code they are sending you to defeat them.
                                        </p>
                                    </Card>
                                </Grid>
                                <br />
            ...
            <div style={{ gridArea: 'top' }}>
                { <div style={{ position: 'absolute' }}>
                    ...
                    <animated.img id="monsterImage" style={{
                        height: '100%',
                        width: '100%',
...
const RadioContent = () => {
    return (
        <div className="radiocontent" >
            ...
            <p id="tutorialText" value="Change Text">Welcome to the Simon Says Game! This pattern game teaches you the Morse Code Alphabet! </p>
